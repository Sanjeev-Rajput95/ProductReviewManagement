    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> productReviews = new List<ProductReview>()
            {
                ...
                new ProductReview() { ProductID = 2, UserID = 2, Rating = 10, Review = "Good", isLike = true },
                ...
                new ProductReview() { ProductID = 2, UserID = 8, Rating = 9, Review = "nice", isLike = false },
                ...
                new ProductReview() { ProductID = 9, UserID = 12, Rating = 5, Review = "Good", isLike = true },
